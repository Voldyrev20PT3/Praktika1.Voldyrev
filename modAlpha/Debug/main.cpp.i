# 1 "main.cpp"
# 1 "/home/igor/Informatika/TiMP/modAlpha//"
# 1 "<built-in>"
# 1 "<command-line>"
      ...
      string decryptedText;
        modAlphaCipher cipher(key);
           cipherText = cipher.encrypt(Text);
            decryptedText = cipher.decrypt(cipherText); cout<<"key="<<key<<endl;
              cout<<Text<<endl;
                     ...
                     if (Text == decryptedText)
                        cout<<"Ok\n";
                                  ...
                                  cout<<"Err\n";
                                   ...
                                   {
                                    check("THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG","SIMPLE"); check("THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG","EXAMPLE"); check("THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG","ABCD");
                                       return 0;
                                       }
